...
@section('content-area')
    <div class="pagetitle">
        <h1>Earn Product List</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="">Home</a></li>
                <li class="breadcrumb-item active">Earn Product List</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
        <div class="row">
            <div class="col-md-6">
                <a class="btn shadow btn-xs sharp me-1 ms-1 text-white" href="{{ url()->previous() }}"
            ...
            <div class="col-md-6 text-end">
                <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"
                    class="btn shadow btn-xs sharp me-5 text-white"
            ...
            <section class="main_content dashboard_part">
                <div class="main_content_iner">
                    <div class="container-fluid plr_30 body_white_bg pt_30">
                        <div class="row justify-content-center" style="margin-top: 0px !important;">
                            <div class="col-lg-12">
                                <div class="row mb" style="margin-bottom: 30px; margin-left: 5px;">

                                    {{-- <div class="col-md-1 mt-4">
                                        <a href="#"  data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo" class="btn shadow btn-xs sharp me-1 text-white"
                                                        ...
                                                        <tr class="text-center">
                                                            ...
                                                            <td>
                                                                <a href="{{ asset($product->image) }}">
                                                                    <img src="{{ asset($product->image) }}" alt=""
                                                                        srcset="" class="rounded-circle" width="35"
                                                                        height="35">
                                                                </a>
                                                            </td>
                                                            <td>{{ $product->price }}</td>
                                                            ...
                                                            <td class="text-center d-flex justify-content-center">
                                                                <select name="category" id=""
                                                                    ...
                                                                    class="form-select change-status-dropdown"
                                                                    style="width:7rem;">
                                                                    <option value="1"
                                                            ...
                                                            <td>
                                                                <a href="" class="btn btn-primary edit-btn btn1"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#editManagerModal"
                                                                    data-bs-whatever="@mdo"
                                                                    style="background-color: #033496;border:none"
                                                                    data-id="{{ $product->id }}"
                                                                    data-name="{{ $product->name }}"
                                                                    data-price="{{ $product->price }}">
                                                                    <i class="fas fa-pencil-alt"></i>
                                                                </a>
                                                                <a href="#" class="btn btn-danger delete-btn btn1"
                                                                    data-id="{{ $product->id }}">
