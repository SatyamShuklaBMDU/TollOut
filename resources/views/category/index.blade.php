                                            ...
                                            <table id="customerTable" class="display nowrap table-centered" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="text-center">
                                                        ...
                                                        <td><a href="{{url('/subcategory/show/'.$category->id)}}">{{ $category->name }}</a></td>
                                                        <td class="text-center d-flex justify-content-center">
                                                            <select name="category" id="" data-user-id="{{$category->id}}" class="form-select change-status-dropdown"style="width:7rem;">
